...
namespace ContpaqiBridge.Controllers
{
    ...
    public class ProductosController : ControllerBase
    {
        ...
        /// <summary>
        /// Lista los productos existentes en CONTPAQi (vía SDK, primeros N)
        /// </summary>
        [HttpGet]
        ...
        /// <summary>
        /// Busca un producto por su código. Devuelve null si no existe.
        /// </summary>
        [HttpGet("{codigo}")]
        public IActionResult ObtenerPorCodigo([FromRoute] string codigo, [FromQuery] string rutaEmpresa)
        {
            try
            {
                if (string.IsNullOrEmpty(rutaEmpresa))
                ...
                var producto = ((ContpaqiSdkService)_sdkService).ObtenerProductoPorCodigo(rutaEmpresa, codigo);
                if (producto == null)
